...
cc._RF.push(module, '84103WUf/dN+73Z/djgcIPh', 'JoystickBG', __filename);
...
cc.Class({
    ...
    //     this.jsJumpInPlane = false
    // },
    _touchDotStartEvent: function _touchDotStartEvent(event) {
        this.penguinCtrl.moveStart();
    },
    _touchDotEndEvent: function _touchDotEndEvent(event) {
